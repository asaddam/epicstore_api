  ...
  checkout: async (req, res) => {
    try {
      ...
      const payload = {
        ...
        historyUser: {
          name: res_voucher._doc.user.name === undefined ? undefined : res_voucher._doc.user.name,
          phoneNumber: res_voucher._doc.user.phoneNumber === undefined ? undefined : res_voucher._doc.user.phoneNumber
        },

        category: res_voucher._doc.category._id ? null : res_voucher._doc.category._id,
        user: res_voucher._doc.user._id ? null : res_voucher._doc.user._id 
